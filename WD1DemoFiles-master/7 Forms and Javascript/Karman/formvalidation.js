 ...
 *          validation errors
 */
function validate(e) { //2??? prevent default? -------------------
...
function load() {
	...
	// Add event listeners for the radio buttons //1-------------
